/**
 * SecondMatePlugin.java - FirstMate Plugin
 *
 ...
 */
public class SecondMatePlugin extends EBPlugin
{
	//{{{ start() method
	public void start()
	{
	...
	private static void initView(View view)
	{
		...
		{
			SecondMateInputHandler handler = new SecondMateInputHandler(view,
				(DefaultInputHandler)defaultHandler);
			view.setInputHandler(handler);
		}
		else
		{
			Log.log(Log.ERROR, SecondMatePlugin.class,
	...
	private static void unInitView(View view)
	{
		...
		if(handler instanceof SecondMateInputHandler)
		{
			view.setInputHandler(((SecondMateInputHandler)handler).getDefaultHandler());
		}
		else
		{
			Log.log(Log.DEBUG, SecondMatePlugin.class,
				"handler is not SecondMateInputHandler: " + handler);
		}
	}//}}}
